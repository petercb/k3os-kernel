...
var (
	...
	Features = []FeatureTest{
		...
		{Name: "Netfilter ARP FILTER Support", Config: "CONFIG_IP_NF_ARPFILTER", Allowed: []string{"y"}},
		{Name: "Netfilter ARP TABLES Support", Config: "CONFIG_IP_NF_ARPTABLES", Allowed: []string{"y"}},
		{Name: "Netfilter ARP MANGLE Support", Config: "CONFIG_IP_NF_ARP_MANGLE", Allowed: []string{"y"}},
		{Name: "Netfilter IPTABLES LEGACY Support", Config: "CONFIG_IP_NF_IPTABLES_LEGACY", Allowed: []string{"y"}},
		{Name: "Netfilter MANGLE Support", Config: "CONFIG_IP_NF_MANGLE", Allowed: []string{"y"}},
		{Name: "IP_NF TTL Match Support", Config: "CONFIG_IP_NF_MATCH_TTL", Allowed: []string{"y"}},
		{Name: "IP_NF RAW Support", Config: "CONFIG_IP_NF_RAW", Allowed: []string{"y"}},
		{Name: "IP_NF Target MASQUERADE Support", Config: "CONFIG_IP_NF_TARGET_MASQUERADE", Allowed: []string{"y"}},
		{Name: "IP_NF Target NETMAP Support", Config: "CONFIG_IP_NF_TARGET_NETMAP", Allowed: []string{"y"}},
		{Name: "IP_NF Target SYNPROXY Support", Config: "CONFIG_IP_NF_TARGET_SYNPROXY", Allowed: []string{"y"}},
		{Name: "IP_NF Target TTL Support", Config: "CONFIG_IP_NF_TARGET_TTL", Allowed: []string{"y"}},
		{Name: "Netfilter ARP Support", Config: "CONFIG_NETFILTER_FAMILY_ARP", Allowed: []string{"y"}},
		{Name: "Netfilter Compat ARP Support", Config: "CONFIG_NFT_COMPAT_ARP", Allowed: []string{"y"}},
		{Name: "Netfilter FIB Support", Config: "CONFIG_NFT_FIB", Allowed: []string{"y"}},
		{Name: "Netfilter FIB IPv4 Support", Config: "CONFIG_NFT_FIB_IPV4", Allowed: []string{"y"}},
		{Name: "Netfilter Tables ARP Support", Config: "CONFIG_NF_TABLES_ARP", Allowed: []string{"y"}},
